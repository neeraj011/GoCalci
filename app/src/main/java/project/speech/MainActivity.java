        ...
        switch (request_Code)
        {
            case 100:
                if(result_code== RESULT_OK && i!=null)
                {
                    ...
                    input = input.replaceAll("factorial","!");
                    input = input.replaceAll("compute factorial of","!");
                    input = input.replaceAll("factorial of","!");
                    input = input.replaceAll("Squareroot","√");
                    input = input.replaceAll("Square root","√");
                    input = input.replaceAll("Squareroot of","√");
                    input = input.replaceAll("Square root of","√");
                    input = input.replaceAll("compute squareroot of","√");
                    input = input.replaceAll("log","lg");
